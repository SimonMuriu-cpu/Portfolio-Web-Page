...
const About = () => {
  ...
  const education = [
    ...
    },
    {
      ...
      school: 'FreeCodeCamp',
      period: '2022',
      description: 'Comprehensive certification in modern web technologies',
    },
    {
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Passionate full-stack developer with 4+ years of experience creating scalable web applications.
        ...
        <motion.div variants={itemVariants} className="mb-16">
          <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 dark:border-gray-700/20">
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              Since then, I've been passionate about creating digital experiences that solve real-world problems.
              I specialize in the MERN stack and love working with modern technologies to build scalable, user-friendly applications.
            </p>
          </div>
        </motion.div>
